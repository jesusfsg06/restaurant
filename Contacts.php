...
function sendcomment(){
    ...
    $exito = "Se ha enviado corectamente su mensaje";
                ...
                <div class="wrap">
                    <div class="box" style="width: 482px; margin-left: 246px;">
                        <div>
                            ...
                            <form id="ContactForm" action="<?php sendcomment();?>" method="post" enctype="multipart/form-data" onsubmit="return false;">
                                <thead>
                                <tr>
                                    <th>
                                        <?php if(!empty($exito)){
        ...
        <div class="main">
            <header>
                ...
                <nav>
                    <ul id="menu">
                        ...
                        <li><a href="admin/listarecetas.php">Libro de Recetas</a></li>
			...
			<article id="content" style="margin-top:65px">
				<div class="wrap">
					<div class="box" style="width: 482px; margin-left: 246px;">
						<div>
							<h2 class="letter_spacing">Formulario de <span>Cont&aacute;cto</span></h2>
                            <form id="ContactForm" action="conexion.php" method="post" enctype="multipart/form-data" onsubmit="return false;">
								<thead>
                                    <tr>
                                        <th></th>
                                    </tr>
